...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(242);
...
module.exports = __webpack_require__(53)(exports);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(955)("follow-redirects");
    }
    catch (error) { /* */ }
...
async function run () {
  const response = await lib_axios.get('https://pokeapi.co/api/v2/pokemon/ditto');
